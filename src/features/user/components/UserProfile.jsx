...
export default function UserProfile() {
  ...
  const handleEdit = (addrssUpdate, index) => {
    const newUser = { ...user, addresses: [...user.addresses] };
    newUser.addresses.splice(index, 1, addrssUpdate);
  ...
  return (
    <>
      <div className="mx-auto mt-12 max-w-4xl sm:px-8 lg:px-10 bg-white rounded-xl p-6">
        ...
        <div className="mx-auto max-w-6xl px-6 sm:px-8 lg:px-10 border-t border-gray-200 mt-4">
          <button
            onClick={(e) => {
            ...
            type="submit"
            className="rounded-md block mt-4 justify-start bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600"
          >
            Add New Address
          </button>
          {showAddAddressForm ? (
          ...
          {user?.addresses.map((address, index) => (
            <div>
              ...
              <div className="flex justify-between gap-x-6 py-5 p-4 bg-gray-100 mb-3 border-2 rounded-md">
